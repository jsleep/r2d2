...
void loop()
{
  ...
  if(random(2)==1){
    HP_MOVE();
    Serial.println("Called HP function");
  }
  delay(300);
...
void HP_MOVE(){
  int option;
  Serial.println("in holoprojector mode");
  servo11.attach(A0);
  servo12.attach(A1);
  servo13.attach(A2);
  servo14.attach(A3);
  ...
  option=random(4);
  if(option == 1){
//    servo11.write(random(L11, H11));
//    servo12.write(random(L12, H12));
    servo11.write(H11);
    servo12.write(H12);
  }
  if(option == 2){
//    servo13.write(random(L13, H13));
//    servo14.write(random(L14, H14));
    servo13.write(H13);
    servo14.write(H14);    
  }
  if(option == 3){
