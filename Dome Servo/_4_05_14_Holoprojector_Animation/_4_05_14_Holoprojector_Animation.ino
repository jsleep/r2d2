...
const int Min1X = 20; // Min value for X1
const int Max1X = 135; // Max value for X1
const int Min1Y = 0; // Min value for Y1
const int Max1Y = 0; // Max value for Y1

const int Min2X = 0; // Min value for X2
const int Max2X = 0; // Max value for X2
const int Min2Y = 30; // Min value for Y2
const int Max2Y = 150; // Max value for Y2

const int MinTime = 3000; // Minimum time to wait before another servo movement.
const int MaxTime = 10000; // Maximum time to wait before another servo movement.
...
const int servo1Xpin = 2; // PIN on Arduino used for Servo1X
const int servo1Ypin = 3; // PIN on Arduino used for Servo1Y
const int servo2Xpin = 4; // PIN on Arduino used for Servo2X
const int servo2Ypin = 5; // PIN on Arduino used for Servo2Y
...
Servo servo1X; // Define X-Servo 1 (Back)
Servo servo1Y; // Define Y-Servo 1 (Back)
...
loopTime = currentTime;
delay(100);
servo1X.detach(); // detaching servo to defined pin.
servo1Y.detach(); // detaching servo to defined pin.
}
...
loopTime = currentTime;
delay(100);
servo2X.detach(); // detaching servo to defined pin.
servo2Y.detach(); // detaching servo to defined pin.
}
